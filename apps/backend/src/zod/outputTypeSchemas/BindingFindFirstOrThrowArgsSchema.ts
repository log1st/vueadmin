...
export const BindingFindFirstOrThrowArgsSchema: z.ZodType<Prisma.BindingFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ BindingScalarFieldEnumSchema,BindingScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default BindingFindFirstOrThrowArgsSchema;
