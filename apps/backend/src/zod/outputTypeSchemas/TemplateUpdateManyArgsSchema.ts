...
export const TemplateUpdateManyArgsSchema: z.ZodType<Prisma.TemplateUpdateManyArgs> =
  z
    .object({
      data: z.union([
        TemplateUpdateManyMutationInputSchema,
        TemplateUncheckedUpdateManyInputSchema,
      ]),
