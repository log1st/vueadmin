...
export const BindingGroupByArgsSchema: z.ZodType<Prisma.BindingGroupByArgs> = z.object({
  where: BindingWhereInputSchema.optional(),
  orderBy: z.union([ BindingOrderByWithAggregationInputSchema.array(),BindingOrderByWithAggregationInputSchema ]).optional(),
