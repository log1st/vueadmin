...
export const BindingUpsertArgsSchema: z.ZodType<Prisma.BindingUpsertArgs> = z
  .object({
    select: BindingSelectSchema.optional(),
    where: BindingWhereUniqueInputSchema,
    create: z.union([
      BindingCreateInputSchema,
      BindingUncheckedCreateInputSchema,
    ]),
    update: z.union([
      BindingUpdateInputSchema,
      BindingUncheckedUpdateInputSchema,
    ]),
  })
  .strict();
