...
export const TemplateGroupByArgsSchema: z.ZodType<Prisma.TemplateGroupByArgs> =
  z
    .object({
      where: TemplateWhereInputSchema.optional(),
      orderBy: z
        .union([
          TemplateOrderByWithAggregationInputSchema.array(),
          TemplateOrderByWithAggregationInputSchema,
        ])
        .optional(),
