...
export const BindingUpdateManyArgsSchema: z.ZodType<Prisma.BindingUpdateManyArgs> = z.object({
  data: z.union([ BindingUpdateManyMutationInputSchema,BindingUncheckedUpdateManyInputSchema ]),
