...
export const BindingOptionalDefaultsSchema = BindingSchema.merge(z.object({
  id: z.number().int().optional(),
  createdAt: z.coerce.date().optional(),
}))

export type BindingOptionalDefaults = z.infer<typeof BindingOptionalDefaultsSchema>
